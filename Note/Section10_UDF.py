...
@xw.func
@xw.arg("data", pd.DataFrame, expand="table", index=True, header=True)
@xw.ret(expand="table", index=True, header=True)
...
@xw.func
@xw.arg("returns", pd.DataFrame, expand="table", index=False, header=True)
@xw.ret(expand="table", index=True, header=True)
...
@xw.arg("symbols", expand="right")
@xw.ret(expand="table", index=True, header=True)
def financial_data(symbols, startdate, enddate, freq, returns=False, log=False):
    prices = data.DataReader(symbols, data_source="yahoo", start=startdate, end=enddate).Close
...
@xw.func
@xw.arg("left", pd.DataFrame, expand="table", index=True, header=True)
@xw.arg("right", pd.DataFrame, expand="table", index=True, header=True)
@xw.ret(expand="table", index=True, header=True)
